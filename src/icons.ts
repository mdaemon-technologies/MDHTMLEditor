...
// Shared icons used by all skins
...
export const CONFAB_ICONS: IconSet = {
  ...
  blockquote: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 6H3"/><path d="M21 12H8"/><path d="M21 18H8"/><path d="M3 12v6"/></svg>',
  alignleft: SVG_ALIGN_LEFT,
  aligncenter: SVG_ALIGN_CENTER,
  alignright: SVG_ALIGN_RIGHT,
  alignjustify: SVG_ALIGN_JUSTIFY,
  removeformat: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="2.7 16.8 7 21 13 21 14 20 5 11" fill="currentColor" fill-opacity="0.3" stroke="none"/><path d="m7 21-4.3-4.3a2 2 0 0 1 0-2.8l9.6-9.6a2 2 0 0 1 2.8 0l5.6 5.6a2 2 0 0 1 0 2.8L13 21"/><path d="M22 21H7"/><path d="m5 11 9 9"/></svg>',
